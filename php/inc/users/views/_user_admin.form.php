 ...
 *
 * @version $Id: _user_admin.form.php 9 2011-10-24 22:32:00Z fplanque $
 */
...
$Form->begin_fieldset( T_('Additional info') );
	...
	// fp> doesn't seem to work in 4.1.1 - $Form->info_field( T_('# of sessions'), $edited_User->get_num_sessions( true ) );
