 ...
 *
 * @version $Id: _misc.funcs.php 1594 2012-07-26 04:07:31Z sam2kb $
 */
...
{
	global $debug, $app_name, $app_version, $current_locale, $current_charset, $evo_charset, $locales, $Debuglog, $notify_from, $demo_mode;
...
/**
 * Create array_combine function if it does not exist ( PHP < 5.0 )
 *
 * @return array
 */
