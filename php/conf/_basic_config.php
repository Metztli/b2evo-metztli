...
$db_config = array(
	...
	'password' => DB2EVOPASS,     // ...and password
	'name'     => DB2EVONAME,  // the name of the database
	'host'     => DB2EVOHOST,    // MySQL Server (typically 'localhost')
);
 ...
 */
$admin_email = 'yourUserName@yourEmailProvider.xyz';
